 ...
 *
 */
public class RocketTempLanderClosedLoopTest_checkInfuenceWind {
    ...
    private void landerSpecs1(double windSpeed) {
        ...
        RocketLanderClosedLoop_checkInfluenceWind rocket = new RocketLanderClosedLoop_checkInfluenceWind(100, new Vector3D(0, 150000
                ,0.0),
    ...
    private void runVerlet(RocketLanderClosedLoop_checkInfluenceWind rocket, Date date) {
        ArrayList<RocketLanderClosedLoop_checkInfluenceWind> obj = new ArrayList<>();
        obj.add(rocket);
