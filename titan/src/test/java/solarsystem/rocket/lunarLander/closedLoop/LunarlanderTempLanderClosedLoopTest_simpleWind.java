 ...
 *
 */
public class LunarlanderTempLanderClosedLoopTest_simpleWind {
    ...
    private void landerSpecs1(double windSpeed) {
        ...
        LunarlanderLanderClosedLoop rocket = new LunarlanderLanderClosedLoop(100, new Vector3D(700, 150000
                ,0.02),
    ...
    private void landerSpecs2(double windSpeed) {
        Date date = new Date(2000,0,1,0,0,0);
        LunarlanderLanderClosedLoop rocket = new LunarlanderLanderClosedLoop(100, new Vector3D(1000, 180000
                ,0),
    ...
    private void runVerlet(LunarlanderLanderClosedLoop rocket, Date date) {
        ArrayList<LunarlanderLanderClosedLoop> obj = new ArrayList<>();
        obj.add(rocket);
...
//            createChart(t_xpos, x_xpos, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_x_dist");
//            createChart(t_xvel, x_xvel, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_x_vel");
//            createChart(t_xacc, x_xacc, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_x_acc");
//            createChart(t_xjerk, x_xjerk, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_x_jerk");
