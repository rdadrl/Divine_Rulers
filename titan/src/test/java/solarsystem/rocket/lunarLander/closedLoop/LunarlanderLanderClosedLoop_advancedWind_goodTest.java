 ...
 *
 */
public class LunarlanderLanderClosedLoop_advancedWind_goodTest {
    ...
    private void runODE(LunarlanderLanderClosedLoop_advancedWind_good rocket, Date date) {
        ...
        for (int i = 0; i < (2000 * (1d / 0.01)); i++) {
            ...
            if (CHART) {
                ...
                //x_jerk_avg.add(InterPlanetaryRocketToTitan.getAverageJerkX());
                t_10.add(rocket.getTotalTime());
                //x_acc_avg.add(InterPlanetaryRocketToTitan.getAverageAccX());
            ...
            if (PRINT) {
                if (i % PRINT_INTERVAL == 0) {
                    rocket.printStatus();
                    //if(i < 1000) System.out.println(InterPlanetaryRocketToTitan.totTime + ", " + InterPlanetaryRocketToTitan.getCentralJerk().getX());
                }
            }
...
//            createChart(t, x_jerk_avg, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_x_jerk_avg_z", -0.01, 0.01, Hl);
//            createChart(t, x_jerk_avg, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_x_jerk_avg", 0, 0, Hl);
//            createChart(t, x_acc_avg, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_x_acc_avg", 0, 0, Hl);

//            createChart(t, x_jerk_avg, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_x_jerk_avg_z_max", -0.2, 0.2, Hl);
            createChart(t, x_pos, rocket.getMeanWindSpeed() + "_x_pos_z", -20, 20, Hl);
//            createChart(t, x_vel, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_x_vel_z", -0.5, 0.5, Hl);
//            createChart(t, x_acc, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_x_acc_z", -0.05, 0.05, Hl);
//            createChart(t, x_jerk, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_x_jerk_z", -0.01, 0.01, Hl);
            createChart(t, x_pos, rocket.getMeanWindSpeed() + "_x_pos", 0, 0, Hl);
            createChart(t, x_vel, rocket.getMeanWindSpeed() + "_x_vel", 0, 0, Hl);
//            createChart(t, x_acc, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_x_acc", 0, 0, Hl);
//            createChart(t, x_jerk, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_x_jerk", 0, 0, Hl);
            createChart(t, y_pos, rocket.getMeanWindSpeed() + "_y_pos", 0, 0, Hl);
            createChart(t, y_vel, rocket.getMeanWindSpeed() + "_y_vel", 0, 0, Hl);
//            createChart(t, y_acc, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_y_acc", 0, 0, Hl);
//            createChart(t, y_jerk, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_y_jerk",0, 0, Hl);
            createChart(t, t_pos, rocket.getMeanWindSpeed() + "_t_pos", 0, 0, Hl);
//            createChart(t, t_vel, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_t_vel",0, 0, Hl);
//            createChart(t, t_acc, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_t_acc",0, 0, Hl);
            createChart(t, Ft_list, rocket.getMeanWindSpeed() + "_Ft", 0, 0, Hl);
//            createChart(t, Fl_list, InterPlanetaryRocketToTitan.getMeanWindSpeed() + "_Fl",0, 0, Hl);
