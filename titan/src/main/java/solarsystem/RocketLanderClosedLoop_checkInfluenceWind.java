 ...
 *
 */
public class RocketLanderClosedLoop_checkInfluenceWind extends Rocket{
    ...
    public RocketLanderClosedLoop_checkInfluenceWind(double length, Vector3D centralPos,
