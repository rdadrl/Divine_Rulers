...
public class LunarlanderLanderOpenLoopVerletWind extends Lunarlander {
    ...
    private boolean time_conversion;
    ...
    public LunarlanderLanderOpenLoopVerletWind(Vector3D centralPos,
                                               Vector3D centralVel, boolean stochasticWind, double meanWindSpeed, Date date) {
        super();
    ...
    public void setAcceleration(ArrayList<? extends CelestialObject> objectsInSpace, Date date) {
        ...
        if (!rot1_done) {
            ...
            if(dt!=0 && !time_conversion){
                time_conversion=true;
                timeCurrentPhase=timeCurrentPhase/dt;
                if (timeCurrentPhase%2!=0){
                    timeCurrentPhase=timeCurrentPhase+dt;
                }
                timeCurrentPhase=timeCurrentPhase*dt;
            }
