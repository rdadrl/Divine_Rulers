...
public class LunarLanderOpenLoopEuler extends Projectile {
    ...
    xRocket is starting x position of the Lunarlander
     */
    public LunarLanderOpenLoopEuler(Vector3D centralPos, Vector3D centralVel, double xLandingPad ){
        super();
    ...
    public static void main (String[] args){
        LunarLanderOpenLoopEuler rocket=new LunarLanderOpenLoopEuler(new Vector3D(1000,20000,0),
