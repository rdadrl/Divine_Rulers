...
public class RocketLanderOpenLoop extends Projectile {
     ...
     */
    public RocketLanderOpenLoop(Vector3D centralPos, Vector3D centralVel,double xLandingPad ){
    ...
    public static void main (String[] args){
        RocketLanderOpenLoop rocket=new RocketLanderOpenLoop(new Vector3D(600,1500,0),
