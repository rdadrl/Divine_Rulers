 ...
 */
public class Date2 extends GregorianCalendar {
    public Date2() {
    }

    public Date2(TimeZone zone) {
        super(zone);
    }

    public Date2(Locale aLocale) {
        super(aLocale);
    }

    public Date2(TimeZone zone, Locale aLocale) {
        super(zone, aLocale);
    }

    public Date2(int year, int month, int dayOfMonth) {
        super(year, month, dayOfMonth);
    }

    public Date2(int year, int month, int dayOfMonth, int hourOfDay, int minute) {
        super(year, month, dayOfMonth, hourOfDay, minute);
    }

    public Date2(int year, int month, int dayOfMonth, int hourOfDay, int minute, int second) {
