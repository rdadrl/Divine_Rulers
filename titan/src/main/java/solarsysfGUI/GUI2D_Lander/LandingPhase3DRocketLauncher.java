...
public class LandingPhase3DRocketLauncher extends Application { //TODO: Should rename visualizer as used for launch and landing
    @Override
...
// TODO: TitanFocus3D should work with Spacecraft as well
            Application landingPhaseApp = new TitanFocus3D(new RocketLauncher(new Vector3D(0,0,0),
