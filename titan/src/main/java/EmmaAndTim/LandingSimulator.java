...
public class LandingSimulator extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        button.setOnAction((event) -> {
            Task<Void> task = new Task<Void>() {
                public Void call() throws Exception {
                    for(int i = 0; i < 100; ++i) {
                        System.out.println("T = " + LandingSimulator.this.t);
                        ++LandingSimulator.this.t;
                        this.updateMessage("\t\tT: " + LandingSimulator.this.t + "\n\t\tX: " + LandingSimulator.this.x + "\n\t\tY: " + LandingSimulator.this.y);
                        Thread.sleep(250);
                    }
        ...
        root.getChildren().addAll(new Node[]{canvas, button, label, titan});
